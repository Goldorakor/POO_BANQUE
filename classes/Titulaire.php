...
class Titulaire {
    ...
    public function afficherInformationsGlobales () {
        $result = "<h4>Informations de $this</h4>Son âge est de ".$this->getAgeTitulaire()." ans, il vit à ".$this->getVille().".<br>Voici la liste de ses comptes bancaires avec les détails de chaque compte :<ul>";
